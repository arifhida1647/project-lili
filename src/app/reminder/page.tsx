      ...
      <main className='mx-2'>
        ...
        <div>
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mt-4 flex justify-center"
          >
            Add Reminder
          </button>
        </div>
        ...
        />
        <ol className="relative border-s mt-10 mx-5 border-gray-200">
          {reminders.map((reminder) => (
            <li className="mb-10 ms-6 " key={reminder.id}>
              ...
              <button onClick={() => deleteReminder(reminder.id)} className='inline-flex items-center px-4 py-2 text-sm font-medium text-gray-100 bg-red-600 border border-gray-200 rounded-lg hover:bg-red-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700'>
                Delete
              </button>
            </li>
          ))}
